...
def mock_pcloud(mocker):
    ...
    mock_instance.listfolder.return_value = {"metadata": {"contents": []}}
    # Default: Create folder returns a success ID
    mock_instance.createfolder.return_value = {"metadata": {"folderid": 12345}}
...
def test_ensure_diary_folder_creates_new(mock_pcloud):
    ...
    mock_pcloud.listfolder.return_value = {"metadata": {"contents": []}}
    # Setup: createfolder returns new ID
    mock_pcloud.createfolder.return_value = {"metadata": {"folderid": 555}}
